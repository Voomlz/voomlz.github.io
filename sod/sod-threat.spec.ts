  ...
  test("Druid Tank", async ({ page }) => {
    ...
    await expect(page.locator("#threatTableContainer")).toMatchAriaSnapshot(`
      ...
      - table:
          ...
          - row "Defender's Resolve	539.29	6.98"
          - row "Gore	476.79	6.17"
          - row "Wild Strike	342.25	4.43"
          - row "Faerie Fire (Feral)	227.13	2.94"
          - row "Berserk	130.54	1.69"
          - row "Kiss of the Spider	126.18	1.63"
          - row "Primal Fury	125.47	1.62"
          - row "Animal Fury	98.94	1.28"
          - row "Natural Reaction	18.97	0.25"
          - row "Survival Instincts	9.71	0.13"
          - row "Total	1277636.43	16536.84"
      `);
  });
  ...
  test("Warlock Tank", async ({ page }) => {
    ...
    await expect(page.locator("#threatTableContainer")).toMatchAriaSnapshot(`
      ...
      - table:
          ...
          - row "Dance of the Wicked	2119.58	12.55"
          - row "Shadow and Flame	1645.79	9.74"
          - row "Demonic Grace	733.26	4.34"
          - row "Fel Armor	587.43	3.48"
          - row "Defender's Resolve	222.42	1.32"
          - row "Major Healthstone	184.26	1.09"
          - row "Vengeance	148.90	0.88"
          - row "Infernal Armor	48.98	0.29"
          - row "Speed	22.33	0.13"
          - row "Total	1905443.79	11278.49"
      `);
  });
