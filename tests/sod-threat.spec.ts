  ...
  test("Warrior Tank", async ({ page }) => {
    ...
    await expect(page.locator("#threatTableContainer")).toMatchAriaSnapshot(`
      ...
      - table:
          ...
          - row "Taunt	128610.16	1199.89"
          - row "Shield Slam	41956.92	391.44"
          - row "Heroic Strike	28372.12	264.70"
          - row "Devastate	26927.68	251.23"
          - row "Melee	22050.30	205.72"
          - row "Deep Wound	19031.80	177.56"
          - row "Revenge	10955.74	102.21"
          - row "Thunderfury	9034.08	84.28"
          - row "Sunder Armor	6127.86	57.17"
          - row "Cleave	2238.61	20.89"
          - row "Rallying Cry	1347.46	12.57"
          - row "Wild Strike	1184.13	11.05"
          - row "Defender's Resolve	653.31	6.10"
          - row "Sword and Board	571.65	5.33"
          - row "Shield Bash	436.39	4.07"
          - row "Battle Shout	244.99	2.29"
          - row "Thorium Shield Spike	183.74	1.71"
          - row "Thorns	169.45	1.58"
          - row "Wrath of Wray	61.25	0.57"
          - row "Bloodrage	40.00	0.37"
          - row "Total	300197.64	2800.74"
      `);
  });
