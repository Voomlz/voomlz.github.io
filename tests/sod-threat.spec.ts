  ...
  test("Warrior Tank", async ({ page }) => {
    ...
    await expect(page.locator("#threatTableContainer")).toMatchAriaSnapshot(`
      ...
      - table:
          ...
          - row "Shield Slam 70417.21 656.97"
          - row "Heroic Strike 47617.54 444.26"
          - row "Devastate 45193.31 421.64"
          - row "Melee 37007.50 345.27"
          - row "Deep Wound 31941.47 298.00"
          - row "Taunt 26781.30 249.86"
          - row "Revenge 18387.25 171.55"
          - row "Thunderfury 15162.09 141.46"
          - row "Sunder Armor 10284.52 95.95"
          - row "Cleave 3757.12 35.05"
          - row "Rallying Cry 2261.46 21.10"
          - row "Wild Strike 1987.35 18.54"
          - row "Defender's Resolve 1096.47 10.23"
          - row "Sword and Board 959.41 8.95"
          - row "Shield Bash 732.41 6.83"
          - row "Battle Shout 411.18 3.84"
          - row "Thorium Shield Spike 308.38 2.88"
          - row "Thorns 284.40 2.65"
          - row "Wrath of Wray 102.79 0.96"
          - row "Bloodrage 40.00 0.37"
          - row "Total 314733.15 2936.35"
      `);
  });
  ...
  test.describe("special threat mechanics", () => {
    test("Patchwerk - Warrior - MT", async ({ page }) => {
      ...
      - table:
          ...
          - row "Shield Slam	128300.88	1791.59"
